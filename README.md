...
* Modifiers like `DamageUpgrade`, `SpeedUpgrade`, `HealUpgrade`, `FireRateUpgrade`, `MaxHealthUpgrade`, `SplitShotUpgrade`, `RearGunUpgrade`, `BulletSpeedUpgrade`, `MagnetUpgrade` and `PierceUpgrade` alter structural thresholds at runtime.
